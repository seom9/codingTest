...
public class Solution_17 {
	...
	*/
	...
	private HashMap<Character, Integer> turnToHash(String[] keymap){
        // 시간복잡도가 O(1) 인 HashMap 저장해 뽑아내는
    ...
    public int[] solution(String[] keymap, String[] targets) {
        ...
        HashMap<Character, Integer> hm = turnToHash(keymap);
