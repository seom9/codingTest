...
public class S59_과일장수 {
	...
	*/
    ...
    // for 문 조금 더 생각해 봤으면 쉽게 풀었을 듯?
	
	private Integer[] getNewScore(int[] score) {
		Integer[] newScore = new Integer[score.length];
    ...
    public int solution1(int k, int m, int[] score) {
        ...
        Integer[] newScore = getNewScore(score);
